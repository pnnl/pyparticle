import pathlib, yaml, pytest, importlib.util

# Load harness.py by path to avoid package import issues during pytest collection
harness_path = pathlib.Path(__file__).parent / "harness.py"
spec = importlib.util.spec_from_file_location("tests_integration_harness", str(harness_path))
harness = importlib.util.module_from_spec(spec)
spec.loader.exec_module(harness)
run_scenario_file = harness.run_scenario_file
